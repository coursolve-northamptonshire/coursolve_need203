...
class TwitterTester(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.northants_geo = '(52.240477000000000000,-0.902655999999979000,50mi)'
        self.northants_radius = (52.240477000000000000, -0.902655999999979000, '50mi')
        #track='india'
        self.fetcher = twitter.create_datafetcher("/home/anshuman/.twitter_api_keys.json")
    ...
    def test_stream_filter(self):
        ...
        twcurl_cmd = self.fetcher.generate_curl_cmdline(command=\
